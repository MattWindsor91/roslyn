    ...
    internal static class TypeDeclarationSyntaxExtensions
    {
            ...
            this TypeDeclarationSyntax node, params MemberDeclarationSyntax[] members)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).AddMembers(members);
            ...
            this TypeDeclarationSyntax node, SyntaxList<MemberDeclarationSyntax> members)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithMembers(members);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxList<AttributeListSyntax> attributes)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithAttributeLists(attributes);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxToken identifier)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithIdentifier(identifier);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxTokenList modifiers)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithModifiers(modifiers);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, TypeParameterListSyntax list)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithTypeParameterList(list);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, BaseListSyntax list)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithBaseList(list);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithConstraintClauses(constraintClauses);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxToken openBrace)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithOpenBraceToken(openBrace);
                case SyntaxKind.ClassDeclaration:
            ...
            this TypeDeclarationSyntax node, SyntaxToken closeBrace)
        {
            switch (node.Kind())
            {
                ...
                case SyntaxKind.InstanceDeclaration: // @MattWindsor91 (Concept-C# 2017)
                    return ((InstanceDeclarationSyntax)node).WithCloseBraceToken(closeBrace);
                case SyntaxKind.ClassDeclaration:
