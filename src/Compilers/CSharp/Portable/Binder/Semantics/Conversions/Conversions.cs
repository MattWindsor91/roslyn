...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class Conversions : ConversionsBase
    {
        ...
        private static Conversion ToConversion(OverloadResolutionResult<MethodSymbol> result, MethodGroup methodGroup, NamedTypeSymbol delegateType)
        {
            ...
            // Synthesised witness methods aren't static, but have no receiver.
            // TODO: this shouldn't be a type switch.
            if (!method.IsStatic && !(method is SynthesizedWitnessMethodSymbol) && methodGroup.Receiver.Type.IsByRefLikeType)
            {
                return Conversion.NoConversion;
            }
